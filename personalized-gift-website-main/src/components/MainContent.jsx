    ...
    >
      ...
      <div className="space-y-4 flex-1 overflow-y-auto overflow-x-hidden rounded-xl custom-scrollbar">
        {[
          ...
          { date: "26 April, 2025", event: "First Kiss", emoji: "💏" },
          { date: "26 April, 2025", event: "First Hug", emoji: "🤗" },
          {
            date: "3 May, 2025",
    ...
    >
      <div className="flex flex-col items-center justify-center h-full text-center px-4">
        ...
        <div className="w-full max-w-md space-y-8">
          ...
          >
            <TimeCounter startDate="2025-4-3" label="As Friends" />
          </motion.div>
          <motion.div
            initial={{ opacity: 0, x: 20 }}
            animate={{ opacity: 1, x: 0 }}
          ...
          >
            <TimeCounter startDate="2025-4-21" label="As a Couple" />
          </motion.div>
        </div>
        <motion.div
          className="mt-6"
      ...
      <div className="bg-white rounded-xl p-6 shadow-md overflow-y-auto flex-1 custom-scrollbar">
        <div className="relative z-10">
          <div className="text-gray-700 text-lg leading-relaxed mb-4">
            <p>
              Aye Vanshi itni Pyaari kyu hai re tu, hmm kya bolu its just
              beautiful ki mai tere itne kareeb aagya wo bhi just 1 mahine ke
              andar, kabhi kabhi yakeen nhi hota hai ki ye sb true hai. I feel
              incredibly grateful to have someone like you by my side, someone
              who understands me without even saying a word, someone who brings
              light even on the darkest days. Through ups and downs, laughter
              and tears, you've been a constant source of strength and
              happiness. As we continue to write our journey together, I want
              you to always remember that you are deeply cherished, endlessly
              appreciated, and truly loved. Teri awaaz jb tu usse mujhe bulati
              hai mujhe bahut sukoon milta hai.You are, and always will be, my
